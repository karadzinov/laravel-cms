                ...
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        ...
                        <button class="btn btn-default shiny" type="button">
                            <a href="#" class="clear-search" data-toggle="tooltip" title="{{ trans('usersmanagement.tooltips.clear-search') }}" style="display:none;">
                                <i class="fa fa-fw fa-times" aria-hidden="true"></i>
                            </a>
                            <a href="#" id="search_trigger" data-toggle="tooltip" data-placement="bottom" title="{{ trans('usersmanagement.tooltips.submit-search') }}" >
