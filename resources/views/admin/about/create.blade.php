            ...
            <div class="widget-body">
                {!! Form::open(array('route' => ['admin.about.store'], 'method' => 'POST', 'role' => 'form', 'files'=> true, 'id'=>'main_form')) !!}
                    <div class="form-group">
                        ...
                        {!! Form::textarea('welcome_note', null, ['id'=>'title', 'class' => 'form-control', 'placeholder'=>'Welcome Note', 'autofocus' => true ]) !!}
                        {!! $errors->first('welcome_note') !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('about', 'About:') !!}
                         <span class="input-icon icon-right">
                            {!! Form::textarea('about', null, ['id'=>'elm1', 'class' => 'form-control', 'placeholder'=>'About']) !!}
                    ...
                    <div class="form-group">
                        {!! Form::label('offer', 'Our Offer:') !!}
                         <span class="input-icon icon-right">
                            {!! Form::textarea('offer', null, ['id'=>'elm2', 'class' => 'form-control', 'placeholder'=>'Our Offer']) !!}
                            <i class="fa fa-pencil darkorange"></i>
                        </span>
                        {!! $errors->first('offer') !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('why_us', 'Why Us:') !!}
                         <span class="input-icon icon-right">
                            {!! Form::textarea('why_us', null, ['id'=>'elm3', 'class' => 'form-control', 'placeholder'=>'Why Us']) !!}
                            <i class="fa fa-pencil darkorange"></i>
                        </span>
                        {!! $errors->first('why_us') !!}
                    </div>
