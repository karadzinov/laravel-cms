...
{{-- GitLab --}}
<div class="col-sm-6 mb-2">
    {!! HTML::icon_link(route('social.redirect',['provider' => 'gitlab']), 'fa fa-gitlab', 'GitLab', array('class' => 'btn btn-block btn-social btn-gitlab')) !!}
</div>

{{-- bitbucket --}}
<div class="col-sm-6 mb-2">
    {!! HTML::icon_link(route('social.redirect',['provider' => 'bitbucket']), 'fa fa-bitbucket', 'BitBucket', array('class' => 'btn btn-block btn-social btn-bitbucket')) !!}
</div>
...
{{-- linkedin --}}
<div class="col-sm-6 mb-2">
    {!! HTML::icon_link(route('social.redirect',['provider' => 'linkedin']), 'fa fa-linkedin', 'LinkedIn', array('class' => 'btn btn-block btn-social btn-linkedin btn-info')) !!}
</div>
