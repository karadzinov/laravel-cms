    			...
    			<div class="profile-container">
    				<div class="profile-header row">
                        <div class="col-lg-2 col-md-4 col-sm-12 text-center">
                            <img src="@if ($user->profile && $user->profile->avatar_status == 1) {{ $user->profile->avatarThumbnail }} @else {{ Gravatar::get($user->email) }} @endif" alt="{{ $user->name }}" alt="" class="header-avatar">
                        </div>
